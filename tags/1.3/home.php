...
<?php if (have_posts()) : ?>
<?php if ($mytheme->option['homepostcount'] == 'limit') { query_posts('showposts=1'); } ?>
...
<?php if ($mytheme->option['homepostcount'] == 'default') { /* THEME OPTION TO SHOW NAV LINKS IF DISPLAYING DEFAULT  POST AMOUNT */ ?>
